    ...
    reader.addEventListener("load", function ()
        {
            ...
            var byteAmount = unescape(encodeURIComponent(ImageHREF)).length
            if(byteAmount<2000000)
            {
                 var image = new Image();
                ...
                image.onload = function()
                {
                    ...
                    NaturalWidth=initWidth
                    NaturalHeight=initHeight
            ...
            {
               cw.imgTooBigSpan.innerHTML="File byte size greater than 2 MB"
...
function finishDrawImage()
{
    ...
    if(EditImage==true)
        ...
        else if(document.getElementById("activeElem"))
        {
            ...
            finishedElem.setAttribute("naturalWidth", NaturalWidth)
            finishedElem.setAttribute("naturalHeight", NaturalHeight)
